  ...
  return (
    <section className="relative flex flex-col items-center justify-center min-h-screen overflow-hidden px-4 sm:px-6 lg:px-8 pt-16 lg:pt-20 pb-12 sm:pb-16 lg:pb-20 bg-linear-to-br from-slate-950 via-purple-950 to-slate-900">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-48 h-48 sm:w-64 sm:h-64 lg:w-80 lg:h-80 bg-linear-to-r from-purple-500/10 to-pink-600/10 rounded-full blur-3xl" />
      ...
      >
        {/* Trust Badge */}
        <motion.div variants={itemVariants} className="inline-flex items-center gap-2 mb-4 sm:mb-6 px-3 py-1.5 sm:px-4 sm:py-2 bg-linear-to-r from-blue-500/10 to-purple-500/10 backdrop-blur-xl rounded-xl sm:rounded-2xl border border-white/20 shadow-lg">
          <div className="flex items-center gap-1 sm:gap-2">
            <RiSparklingLine className="text-yellow-400" size={14} />
            <span className="text-white text-xs sm:text-sm font-semibold bg-linear-to-r from-white to-gray-300 bg-clip-text tracking-wider">
        ...
        <motion.h1 variants={itemVariants} className="hero-heading text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl mb-4 sm:mb-6">
          <span className="bg-linear-to-r from-blue-400 via-purple-500 to-cyan-400 bg-clip-text text-transparent bg-300% animate-gradient">
            MASTER
          </span>{' '}
          <span className="text-white">AI &</span>
          <br />
          <span className="bg-linear-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent bg-300% animate-gradient">
            MACHINE LEARNING
          </span>
        </motion.h1>
        ...
        <motion.p variants={itemVariants} className="hero-subtitle text-base sm:text-lg md:text-xl text-gray-300 mb-6 sm:mb-8 md:mb-12 max-w-xs sm:max-w-md md:max-w-2xl lg:max-w-3xl mx-auto">
          ...
          <span className="text-white font-semibold bg-linear-to-r from-blue-400 to-purple-400 bg-clip-text">
            top platforms
        ...
        <motion.div variants={itemVariants} className="flex flex-wrap justify-center gap-3 sm:gap-4 md:gap-6 mb-8 sm:mb-12 md:mb-16 px-2">
          {platforms.map((platform, index) => (
            ...
            >
              <div className="w-1.5 h-1.5 bg-linear-to-r from-blue-400 to-purple-400 rounded-full" />
